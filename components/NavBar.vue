<template>
  <nav class="w-full p-6 bg-transparent">
    <div>
      ...
      <!-- Navbar -->
      <div class="flex flex-row justify-around sm:hidden md:contents">

          <NuxtLink to="/about" class="About"> About </NuxtLink>
          <NuxtLink to="/" class="title">Home</NuxtLink>
          <NuxtLink to="/posts" class="Post">Players</NuxtLink>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><button @click="navigate('/posts')" class="my-4 inline-block">Players</button></li>
        </ul>

      </aside>

        <div class="follow">
          <p class="italic font-heading text-sm">follow us:</p>
...
.title:hover , .About:hover , .Post:hover {
    color: blue;
    border-color: blue;
